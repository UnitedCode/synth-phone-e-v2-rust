...
/// Major Key Scales
/// =======================================
pub const C_MAJOR_SCALE: KeyScale = (["C",  "D",  "E",  "F",  "G",  "A",  "B"], C_MAJOR_SCALE_FREQUENCIES);
pub const G_MAJOR_SCALE: KeyScale = (["G",  "A",  "B",  "C",  "D",  "E",  "F#"], G_MAJOR_SCALE_FREQUENCIES);
pub const D_MAJOR_SCALE: KeyScale = (["D",  "E",  "F#", "G",  "A",  "B",  "C#"], D_MAJOR_SCALE_FREQUENCIES);
pub const A_MAJOR_SCALE: KeyScale = (["A",  "B",  "C#", "D",  "E",  "F#", "G#"], A_MAJOR_SCALE_FREQUENCIES);
pub const E_MAJOR_SCALE: KeyScale = (["E",  "F#", "G#", "A",  "B",  "C#", "D#"], E_MAJOR_SCALE_FREQUENCIES);
pub const B_MAJOR_SCALE: KeyScale = (["B",  "C#", "D#", "E",  "F#", "G#", "A#"], B_MAJOR_SCALE_FREQUENCIES);
pub const F_SHARP_MAJOR_SCALE: KeyScale = (["F#", "G#", "A#", "B",  "C#", "D#", "E#"], FS_MAJOR_SCALE_FREQUENCIES);
pub const C_SHARP_MAJOR_SCALE: KeyScale = (["C#", "D#", "E#", "F#", "G#", "A#", "B#"], CS_MAJOR_SCALE_FREQUENCIES);
pub const F_MAJOR_SCALE: KeyScale = (["F",  "G",  "A",  "Bb", "C",  "D",  "E"], F_MAJOR_SCALE_FREQUENCIES);
pub const BB_MAJOR_SCALE: KeyScale = (["Bb", "C",  "D",  "Eb", "F",  "G",  "A"], BB_MAJOR_SCALE_FREQUENCIES);
pub const EB_MAJOR_SCALE: KeyScale = (["Eb", "F",  "G",  "Ab", "Bb", "C",  "D"], EB_MAJOR_SCALE_FREQUENCIES);
pub const AB_MAJOR_SCALE: KeyScale = (["Ab", "Bb", "C",  "Db", "Eb", "F",  "G"], AB_MAJOR_SCALE_FREQUENCIES);
